...
.. doctest::
    ...
    'Cr_2'
    >>> # c.Cr
    >>> # It will raise Attribute error, since after addition 
    >>> # of the second atom with the same name 
    >>> # information about the index is needed to identify the atom object.

0.7.2
-----

Add magnetic dipole-dipole energy calculator to the :ref:`crystal-api`.
...
0.7.11
------
Bugfix in :py:func:`.plot_2D_array`.