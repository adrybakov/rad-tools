...
For the full reference see :ref:`api_score`.
...
Usage is the same as in the script interface. The only difference is that the
functions are called directly. See :ref:`scripts-guide` for more details.